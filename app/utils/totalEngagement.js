export function getTotalEngagementStats(mergedData, platformNames) {
  ...
  // Format the total engagement value itself as a percentage (rounded to 1 decimal place)
  const formattedTodayPercent = `${totalToday.toFixed(1)}%`;

  return {
    totalToday: formattedTodayPercent,
    displayChange,
  };
}
